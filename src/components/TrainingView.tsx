...
import { Play, Clock, ChevronRight, Zap, Trophy, Target, Star } from 'lucide-react';
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
             ...
             <div className="bg-[#002D57] p-8 rounded-[40px] shadow-xl flex items-center gap-6">
                ...
                <div>
                   <p className="text-3xl font-display font-black text-white">{user.score}</p>
                   <p className="text-[10px] font-black uppercase tracking-widest text-white/40">Ваш рейтинг (XP)</p>
                </div>
             </div>
          </div>
        </section>
